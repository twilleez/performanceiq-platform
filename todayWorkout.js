  ...
  <main class="page-main">
    ...
    <div class="panels-2">
      <div>
        <div class="panel" style="margin-bottom:16px">
          ...
          <div style="display:flex;align-items:center;gap:14px;margin:14px 0">
            ...
            <div><div style="font-weight:700;font-size:15px;color:var(--text-primary)">${user?.name||'Player'}</div><div style="font-size:12.5px;color:var(--text-muted)">${user?.email||''} · ${role.charAt(0).toUpperCase()+role.slice(1)}</div></div>
          </div>
      ...
      <div class="panel"><div class="panel-title">Notification Preferences</div>
        ${[['Coach messages',true],['Readiness alerts',true],['Workout reminders',true],['Team announcements',true],['Progress milestones',false]].map(([l,on])=>`
