/**
 * PerformanceIQ Auth
 * Auth flows, role resolution, session management.
...
/**
 * Sign in — demo: any password works for known emails,
 * or create a new user with the chosen role.
 */
export async function signIn(email, password, roleHint) {
  ...
  // For any other email, create a generic session using the roleHint
