...
export function renderCoachAnalytics(container) {
  container.innerHTML = `
    <div class="view-screen">
      <div class="view-nav-bar">
        ...
        <div class="view-nav-title">TEAM ANALYTICS</div>
        <div style="width:36px;"></div>
      </div>
      <div class="coming-soon-wrap">
        <div class="coming-soon-logo">${mark(56)}</div>
        <div class="coming-soon-icon">📊</div>
        <div class="coming-soon-title">Team Analytics</div>
        <p class="coming-soon-body">ACWR charts, team load trends, injury risk flags, and season overview — all in one dashboard.</p>
  ...
  const flagKey = 'piq_notify_coach_analytics';
