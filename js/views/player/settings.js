      ...
      <div>
        <div class="panel" style="margin-bottom:16px">
          ...
          <div style="display:flex;align-items:center;gap:14px;margin-bottom:16px">
            ...
            <div>
              <div style="font-weight:700;font-size:15px;color:var(--text-primary)">${user?.name||'Player'}</div>
              <div style="font-size:12.5px;color:var(--text-muted)">${user?.email||''} · Player</div>
            </div>
          </div>
