/**
 * Player Readiness View — daily readiness detail
 */
...
export function renderPlayerReadiness() {
  ...
  <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-bottom:1px solid var(--border)">
    ...
    <div style="flex:1">
      <div style="font-size:13.5px;font-weight:600;color:var(--text-primary)">${f.label}</div>
    </div>
  ...
  <main class="page-main">
    ...
    <div class="panels-2">
      ...
      <div class="panel">
        ...
        <div style="margin-top:16px;padding:12px;background:var(--surface-2);border-radius:10px;font-size:12px;color:var(--text-muted)">
          <strong style="color:var(--text-primary)">How is this calculated?</strong><br>
          The Readiness Index is derived from your recent RPE averages (last 5 sessions), workout completion rate, and training load balance. It is updated each time you log a session.
        </div>
      </div>
    </div>
  </main>
