/**
 * Solo — Today's Workout View v2
 * Same elite programming as player view, adapted for solo athletes.
 */
...
<div class="view-with-sidebar">
  ...
  <main class="page-main">
      ...
      <div class="panel" style="border-left:4px solid ${badge.color}">
        <div style="display:flex;align-items:center;gap:12px">
          ...
          <div>
            ...
            ${workout.goalLabel ? `<div style="margin-top:6px;padding:4px 10px;background:rgba(57,230,107,.08);border:1px solid rgba(57,230,107,.2);border-radius:6px;font-size:10px;font-weight:700;color:#39e66b;letter-spacing:.06em;text-transform:uppercase">🎯 \${workout.goalLabel}</div>` : ''}
          </div>
        </div>
      </div>
    </div>
    <div class="panel" style="background:linear-gradient(135deg,#0d1b3e 0%,#1a2f5e 100%);border:1px solid #22c95530;margin-bottom:20px">
      <div>
        <div style="font-size:11px;font-weight:700;color:var(--piq-green);letter-spacing:.08em;text-transform:uppercase">${profile.sport?.toUpperCase() || 'BASKETBALL'} · SOLO TRAINING</div>
...
<div class="panel" style="border:1px solid #22c95540;background:#22c95508">
  ...
  <div style="font-size:13px;color:var(--text-muted);margin-bottom:16px">Your readiness score indicates your body needs recovery today. TB12: "Recovery is training."</div>
  ...
  return `
    ...
    <div style="margin-bottom:20px">
      ...
      <div class="panel" style="padding:14px 16px">
        <div style="font-size:13px;color:var(--text-muted);margin-bottom:12px">${warmup.label}</div>
